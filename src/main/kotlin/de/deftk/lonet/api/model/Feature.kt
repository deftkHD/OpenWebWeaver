...
enum class Feature(val permissions: List<Permission>) {
    ...
    LEARNING_LOG(listOf(LEARNING_LOG_READ, LEARNING_LOG_WRITE, LEARNING_LOG_ADMIN)),
    WALL(listOf(WALL_READ, WALL_WRITE, WALL_ADMIN)),
    SUBSTITUTION_PLAN(listOf(SUBSTITUTION_PLAN_READ, SUBSTITUTION_PLAN_WRITE, SUBSTITUTION_PLAN_ADMIN)),
    RESOURCE_MANAGEMENT(listOf(RESOURCE_MANAGEMENT_READ, RESOURCE_MANAGEMENT_WRITE, RESOURCE_MANAGEMENT_ADMIN)),
    CONSULTATION_HOURS(listOf(CONSULTATION_HOURS_READ, CONSULTATION_HOURS_WRITE, CONSULTATION_HOURS_ADMIN)),
    IMAGES(listOf(Permission.IMAGES)),
    FORMS(listOf(Permission.FORMS)),
