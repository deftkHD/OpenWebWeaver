...
enum class Feature(val permissions: List<Permission>) {
    ...
    LEARNING_LOG(listOf(Permission.LEARNING_LOG, LEARNING_LOG_WRITE, LEARNING_LOG_ADMIN)),
    WALL(listOf(Permission.WALL, WALL_WRITE, WALL_ADMIN)),
    SUBSTITUTION_PLAN(listOf(Permission.SUBSTITUTION_PLAN, SUBSTITUTION_PLAN_WRITE, SUBSTITUTION_PLAN_ADMIN)),
    RESOURCE_MANAGEMENT(listOf(Permission.RESOURCE_MANAGEMENT, RESOURCE_MANAGEMENT_WRITE, RESOURCE_MANAGEMENT_ADMIN)),
    CONSULTATION_HOURS(listOf(Permission.CONSULTATION_HOURS, CONSULTATION_HOURS_WRITE, CONSULTATION_HOURS_ADMIN)),
    IMAGES(listOf(Permission.IMAGES, IMAGES_WRITE, IMAGES_ADMIN)),
    FORMS(listOf(Permission.FORMS, FORMS_WRITE, FORMS_ADMIN)),
