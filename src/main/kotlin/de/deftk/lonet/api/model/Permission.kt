...
enum class Permission(val supported: Boolean, val permission: String): Serializable {
    ...
    BOARD_PUPIL_ADMIN(false, "board_pupil_admin"),
    TASKS(true, "tasks"),
    ...
    POLL(false, "poll"),
    POLL_ADMIN(false, "poll_admin"),
    TIMETABLE(false, "timetable"),
    TIMETABLE_WRITE(false, "timetable_write"),
    LEARNING_PLAN(false, "learning_plan"),
    LEARNING_PLAN_ADMIN(false, "learning_plan_admin"),
    WS_GEN(false, "ws_gen"),
    WS_GEN_ADMIN(false, "ws_gen_admin"),
    WEBSITE(false, "website"),
    WEBSITE_ADMIN(false, "website_admin"),
    SHOWCASE(false, "showcase"),
    SHOWCASE_WRITE(false, "showcase_write"),
    BLOG(false, "blog"),
    BLOG_ADMIN(false, "blog_admin"),
    CLIENT(false, "client"),
